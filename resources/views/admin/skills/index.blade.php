                    ...
                    <div class="card m-b-30">
                        <div class="card-header">
                            <div class="card-header-actions">
                                ...
                                <button class="btn btn-success btn-save float-right" title="Add " id="addcat" data-toggle="modal" data-target="#skill_add_modal" data-id="'.$data->id.'">Add</button>
...
<div class="modal" id="edit-skill" tabindex="-1" role="dialog">
            ...
            <div class="modal-body">
                <form id="editcat">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="" name="skill_name" id="skill_name" placeholder="Type your Category">
...
<script>
    ...
    $(document).on('click', '#btn', function() {
        ...
        // console.log(id);
        var category_name = $('#skill_name').val();
    ...
    $(document).on('click', '.edit', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#skill_name').val(data.data.skill_name);
